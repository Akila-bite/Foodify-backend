const recipes = [
  {
    id: 1,
    name: "Oven-roasted stuffed butternut",
    category: "Dinner",
    image: "/images/Stuffed-butternuts.jpg",
    ingredients: [
      "2 large butternuts ",
...
"sea salt and freshly ground black pepper, to taste ",
  ...
  {
    id: 2,
    name: "Ostritch Sausage Shakshuka",
    category: "Breakfast",
    image: "/images/Ostrich-wors-shakshuka-1.jpg",
    ...
    ingredients: [
      ...
      "410 g can Woolworths peeled and diced tomatoes",
      "200 g cocktail tomatoes, halved",
      "6-8 extra-large free-range eggs",
      "3 T Fresh Italian parsley, coarsely chopped",
     " 2 x 2 packs Woolworths heat & eat garlic naan breads, heated",
  ...
  {
    id: 3,
    name: "Eggs baked in phyllo",
    category: "Breakfast",
    image: "/images/Eggs-baked-in-phyllo.jpg",
  ...
  {
    id: 4,
    name: "Scrambled pancakes",
    category: "Breakfast",
    image: "/images/Scrambled-pancake-recipe.jpg",
...
"icing sugar",
...

  {
    ...
    category: "Breakfast",
    image: "/images/Vegan-breakfast-.jpg",
...
"flatbreads, for serving",
  ...
  {
    id: 6,
    name: "Crispy fried eggs and chakalaka bean salad on toast",
    category: "Breakfast",
    image: "/images/Crispy-fried-eggs-and-chakalaka-bean-salad-on-toast-1.jpg",
...
"sea salt, to taste",
"160 g Woolworths chakalaka bean salad",
...
"fresh coriander, for serving",
  ...
  {
    id: 7,
    name: "Vegan sweet potato crumpets",
    category: "Breakfast",
    image: "/images/Vegan-sweet-potato-crumpets.jpg",
...
"coconut oil, for frying",
  ...
  {
    id: 8,
    name: "Swiss Bircher muesli with caramel bananas",
    category: "Breakfast",
    image: "/images/Swiss-Bircher-muesli-with-caramel-bananas.jpg",
...
"½ cup cream",
  ...
  {
    id: 10,
    name: "Air-fryer baked chocolate chip protein oats",
    category: "Breakfast",
    image: "/images/Air-fryer-baked-chocolate-chip-protein-oats.jpg",
...
"Biscoff biscuit spread, melted, to serve (optional)",
  ...
  {
    id: 11,
    name: "Mieliepap with butter",
    category: "Breakfast",
    image: "/images/Mieliepap-with-butter.jpg",
...
"brown sugar, for serving",
  ...
  {
    id: 12,
    name: "Shredded tofu-and-crispy kale salad",
    category:"Lunch",
    image: "/images/Crispy-Tofu-and-Kale-Salad.jpg",
...
"sesame seeds, for serving",
...

  {
    ...
    category:"Lunch",
    image: "/images/Chicken-mayo-salad.jpg",
...
"2 cup canola oil",
...

  {
    ...
    category:"Lunch",
    image: "/images/Air-fryer-falafel.jpg",
...
"100 g kale, finely chopped",
  ...
  {
    id: 15,
    name: "The ultimate veggie burger",
    category:"Lunch",
...
"4 slices Woolworths vegan cheese slices50 g Italian leaf mix",
...
"Fried brinjal slices (optional)",
  ...
  {
    id: 16,
    name: "Mini cottage cheese-and-egg muffins",
    category:"Lunch",
    image: "/images/Mini-cottage-cheese-and-egg-muffins.jpg",
...
"3 T flour",
  ...
  {
    id: 17,
    name: "Leftover mince pies",
    category:"Lunch",
    image: "/images/Leftover-mince-pies.jpg",
    
    ingredients: [
      "1 ½ cups cooked Bolognese",
"½ cup frozen pea-and-sweetcorn mix",
...
"2 t sesame seeds (optional)",
  ...
  {
    id: 18,
    name: "Roast sweet potato salad",
    category:"Lunch",
    image: "/images/Roast-sweet-potato-salad.jpg",
...
"orange zest, to garnish",
  ...
  {
    id: 19,
    name: "Mini cheese and tuna quiches",
    category:"Lunch",
    image: "/images/Mini-cheese-tuna-quiches-1.jpg",
...
"170 g Woolworths Light Meat Shredded Tuna,  drained",
  ...
  {
    id: 20,
    name: "Asian-style crunchy stir-fry wrap",
    category:"Lunch",
    image: "/images/Asian-style-crunchy-stir-fry-wrap.jpg",
    
    ingredients: [
      "1 Woolworths wholegrain wrap",
"1 cup Woolworths Easy to Wok Bright and Crunchy stir fry, cooked",
"1 x 90 g Caesar salad dressing or Woolworths Slimmer’s Choice sour cream-and-spring onion dressing sachet",
"1 leftover chicken breast or leg",
...
"red onion, chopped, to garnish",
  ...
  {
    id: 21,
    name: "Loaded TLT tuna sandwich",
    category:"",
    image: "/images/Tuna-sandwich.jpg",
    
    ingredients: [
      "1 avocado",
"2 T tangy mayonnaise" ,
"sea salt and freshly ground black pepper, to taste" ,
"8 slices brown sandwich bread ",
"2 x 170 g cans light meat shredded tuna in brine, drained",
...
"¼ cucumber, sliced ",
  ...
  {
    id: 22,
    name: "Loaded Roosterkoek Rolls",
    category:"Dinner",
    image: "/images/Loaded-Roosterkoek-Rolls-1.jpg",
...
"125 g packet Woolworths chakalaka flavoured crisps",
  ...
  {
    id: 23,
    name: "New York cart-style chicken and rice",
    category:"Dinner",
    image: "/images/NEW-YORK-CART-STYLE-CHICKEN-AND-RICE.jpg",
    
    ingredients: [
      "4 T lemon juice",
      "2 T fresh oregano, chopped",
      "1 t ground cuminground cumin",
...
"harissa-style hot sauce (or any other chilli sauce), optional",
  ...
  {
    id: 24,
    name: "Chicken sausage meatball pasta",
    category:"",
    image: "/images/Chicken-sausage-meatball-pasta.webp",
...
"Parmesan, grated, for serving",
  ...
  {
    id: 25,
    name: "Creamed spinach pasta",
    category:"Dinner",
    image: "/images/Creamed-spinach-pasta.jpg",
...
"500 g penne, cooked al dente",
  ...
  {
    id: 26,
    name: "Umngqusho ongqimbilili (Baked creamy cheesy samp)",
    category:"Dinner",
    image: "/images/Umngqusho-ongqimbilili-Baked-creamy-cheesy-samp.jpg",
...
"salt, to taste",
...

  {
    ...
    category:"Dinner",
    image: "/images/SHISANYAMA-STYLE-CHUCK-WITH-HARISSA-CAULIFLOWER-SALAD.jpg",
...
"celery leaves, a handful, roughly chopped (use leftover celery sticks if you have any) ",
  ...
  {
    id: 28,
    name: "Isinkwa nemifino (steamed mielie bread with wild spinach)" ,
    category:"Dinner",
    image: "/images/Isinkwa-nemifino-steamed-mielie-bread-with-wild-spinach.jpg",
...
"100 g imifino (spinach), washed and roughly chopped",
    ...
    instructions: " 1. Wash the mielies, removing the husks and silk. Using a small knife, gently scrape the kernels from the cobs to make 250 g. 2. Reserve 50 g of the kernels to add to the batter, then blend the remaining kernels to make a chunky purée. Set both aside. 3. Sift the flour, salt and baking powder. Cream the eggs, butter and sugar in a mixer and add the mielie purée. Add the dry ingredients and reserved mielie kernels. Mix well to form a smooth batter. 4. Fold in the imifino, taking care not overwork the batter so it doesn’t stain the bread. 5. Pour into a greased or lined stainless-steel bowl, then cover with foil or clingwrap making sure it doesn’t touch the batter. 6. Place in a large saucepan half-filled with water – the bowl should not be submerged in the water. Cover, then steam for 1½ hours over a medium heat. Check the water level every 20 minutes and add more boiling water if necessary. 7. Use a toothpick or skewer to test whether the bread is ready; it should come out dry. If It’s still wet, steam it for a bit longer. Once ready, remove from the saucepan, allow to cool for 5 minutes, then flip the bowl upside down. Place the bread on a wire rack. Serve warm or cold. Cook’s note: You can replace imifino with your favourite leafy vegetable but make sure you drain any excess water "
  },

  {
    id: 29,
    name: "Black bean chakalaka",
    category:"Dinner",
    image: "/images/Black-bean-chakalaka.jpg",
...
"10 g fresh coriander, chopped",
  ...
  {
    id: 30,
    name: "Vegetable curry with pap",
    category:"Dinner",
    image: "/images/Vegetable-curry-with-pap.jpg",
...
"500 g maize meal",
  ...
  {
    id: 31,
    name: "Rooibos honey Basque cheesecake",
    category:"Dessert",
    image: "/images/Rooibos-honey-Basque-cheesecake.jpg",
...
"30 g cake flour",
  ...
  {
    id: 32,
    name: "Tropical coconut rice pudding",
    category:"Dessert",
    image: "/images/Tropical-coconut-rice-pudding.jpg",
    
    ingredients: [
      "90   g  Woolworths risotto rice",
...
"2 T Woolworths toasted coconut flakes, to garnish (optional) ",
  ...
  {
    id: 33,
    name: "Bollas (Doughnuts)",
    category:"Dessert",
    image: "/images/Bollas-Doughnuts.jpg",
...
"250 g desiccated coconut, for sprinkling",
...
"icing sugar, for dusting",
  ...
  {
    id: 35,
    name: "Amagwinya ice-cream sandwiches",
    category:"Dessert",
    image: "/images/Tin-Roof-Banana-Split-1.jpg",
    
    ingredients: [
      "4 Woolworths amagwinya vetkoek",
"2 L Woolworths Tin Roof dairy ice cream",
"280 g Woolworths creamy toffee or chocolate dessert sauce",
"a handful raw almonds, roughly chopped",
  ...
  {
    id: 36,
    name: "Choc-chip-and-caramel ice-cream sandwiches",
    category:"Dessert",
    image: "/images/Choc-chip-and-caramel-ice-cream-sandwiches.jpg",
...
"2 free-range eggs",
"243 g oats",
"360 g Woolworths 27 % cocoa milk chocolate drops",
"Woolworths chocolate dairy ice cream, for serving",
"Woolworths Fantastical multi-coloured egg milk chocolate bites, crushed, for serving",
...
"1 x 360 g can Caramel Treat",
...

  {
    ...
    category:"Dessert",
    image: "/images/Coffee-cupcakes.jpg",
...
"1 t vanilla extract",
  ...
  {
    id: 38,
    name: "Air-fryer chocolate brownies",
    category:"Dessert",
    image: "/images/Air-fryer-chocolate-brownies-.jpg",
    
    ingredients: [
      "125 g unsalted butter, cut into cubes, plus extra for greasing",
"75 g cocoa powder",
"2 eggs",
...
"1 x 385 g can   condensed milk",
  ...
  {
    id: 40,
    name: "Easy Peppermint Crisp tart",
    category:"Dessert",
    image: "/images/Peppermint-Crisp-tart1.jpg",
    
    ingredients: [
      "2 cups (3 x 250ml) Woolies whipping cream, chilled",
...
"2 T sugar",
  ...
  {
    id: 41,
    name: "Spicy Clemenada",
    category:"Drinks",
    image: "/images/Spicy-Clemonada.jpg",
    
    ingredients: [
      "1 t Woolworths honey infused with ghost chill",
      "1 t Woolworths chilli lime sal",
      "3 T Woolworths non-alcoholic Clemengold® mandarin fruit drink concentrate",
      "3 T lime juice",
      "1 cup coconut water, frozen in ice trays",
      "Clemengold® mandarin, sliced, to garnish",
      "lime, sliced, to garnish",
      "your spirit of choice such as blanco tequila or rum (optional)",
  ...
  {
    id: 42,
    name: "The raspberry sparkler",
    category:"Drinks",
    image: "/images/The-raspberry-sparkler.jpg", 
    ingredients: [
...
"rosé or brut Cap Classique, to serve",
  ...
  {
    id: 43,
    name: "Naartjie, espresso and rosemary shrub",
    category:"Drinks",
    image: "/images/Naartjie-espresso-and-rosemary-shrub.jpg",
...
"fresh rosemary sprig, to garnish",
  ...
  {
    id: 44,
    name: "The ClemenGold daiquiri",
    category:"Drinks",
    image: "/images/The-ClemenGold-daiquiri.jpg",
    
    ingredients: [
      "4 T light rum",
"2 T fresh ClemenGold juice, strained",
"2 T fresh lime juice, strained",
"2 t sugar syrup",
"ClemenGold peel, for serving",
  ...
  {
    id: 45,
    name: "Amarula cinnamon hot chocolate",
    category:"Drinks",
    image: "/images/Amarula-1.webp",
    
    ingredients: [
      "½ cup Amarula Ethiopian Coffee Cream liqueur",
"1 stick cinnamon",
...
"1 packet Woolworths frozen mini all butter croissants",
  ...
  {
    id: 46,
    name: "Ginger beer float",
    category:"Drinks",
    image: "/images/Ginger-beer-float.jpg",
...
"Woolworths Extremely Creamy Madagascan vanilla ice cream, for serving",
  ...
  {
    id: 47,
    name: "Kiwiberry sorbet",
    category:"Dessert",
    image: "/images/kiwiberry-sorbet.jpg",
